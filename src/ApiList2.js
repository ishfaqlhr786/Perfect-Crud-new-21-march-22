        ...
        <div className="container22" style={{width:"100vw"}} >
         ...
         <form onSubmit={handleEditFormSubmit} > 
                ...
                <tr style={{backgroundColor:"gray"}}>
                    ...
                    <SelectAll2 list={data}   handleChange={handleChangeChk} />
                    </th>
                    <th style={{paddingLeft:"20px"}}>
                        id
                    </th>
...
{
productId === product.id?   (<Editproduct2 editform={editform}
...
(<ReadOnlyProduct2 product={product} index={index} clickEdit={clickEdit}
